...
const EXECUTION_BASELINE_RECIPE_PROFILE_PATHS = new Map([
  [
  ...
  return async function verify({
    ...
    try {
      if (
        ...
        !EXECUTION_BASELINE_RECIPE_PROFILE_PATHS.has(
      ...
      if (
        recipe.schemaVersion !==
          policy.executionBaselineRecipe.schemaVersion ||
        recipe.acceptanceProfile.path !==
          EXECUTION_BASELINE_RECIPE_PROFILE_PATHS.get(
            policy.executionBaselineRecipe.path,
          ) ||
