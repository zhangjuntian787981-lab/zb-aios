...
export class C11C06AuthorizationError extends Error {
  constructor(code, message) {
    super(message);
    this.name = "C11C06AuthorizationError";
    this.code = code;
  }
}

function fail(code, message) {
  throw new C11C06AuthorizationError(code, message);
}
...
export function createC11C06Authorizer({ authorizationFacade }) {
  ...
  return Object.freeze({
    async enforce(serverContext, request, descriptor) {
      ...
      if (!isC06DecisionBoundToRequest(decision, {
        ...
        fail(
          "AUTHORIZATION_UNAVAILABLE",
          "C06 decision is not bound to this C11 request.",
        );
      }
      return Object.freeze({
