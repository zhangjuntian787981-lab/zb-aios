export class C10C06AuthorizationError extends Error {
  constructor(code, message) {
    super(message);
    this.name = "C10C06AuthorizationError";
    this.code = code;
  }
}

function fail(code, message) {
  throw new C10C06AuthorizationError(code, message);
}
...
export function createC10C06Authorizer({ authorizationFacade }) {
  ...
  return Object.freeze({
    async enforce(serverContext, request, descriptor) {
      ...
      if (
        ...
        decision.surface !== descriptor.surface ||
        ...
        fail(
          "AUTHORIZATION_UNAVAILABLE",
          "C06 decision is not bound to this C10 request.",
        );
      }
      return Object.freeze({
