...
def build_document():
    ...
    doc.add_heading("三、您现在只需要作出七项决定", level=1)
    decisions = [
        ...
        ("指定两级审批人。", "书面指定一名 P0 集中审批人审批推荐包，并指定一名 P1 阶段门审批人作最终 Go / No-Go；两者可由同一人兼任。"),
    ...
    add_callout(
        doc,
        "推荐授权方式",
        "授权项目负责人对 P0 范围内的场景、技术方案、资料清单草案、权限矩阵、验收方案和实施安排进行集中审批。业务、资料、IT 及安全责任人负责对本领域事实和控制能力进行书面核实。涉及人员调动、预算、敏感数据、员工 KPI、真实系统接入及进入 P1 的事项，仍须由总经理或其书面授权人批准。",
        tone="gray",
    )
    ...
    add_form_line(doc, "P0 集中审批人")
    add_form_line(doc, "P1 Go / No-Go 审批人")
